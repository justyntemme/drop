...
// source: gitlab.com/nextwavedevs/drop/internal/proto-files/domain/repository.proto
...
func init() {
	proto.RegisterFile("gitlab.com/nextwavedevs/drop/internal/proto-files/domain/repository.proto", fileDescriptor_0293ad53cd466a6d)
}
